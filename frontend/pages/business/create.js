...
export default function CreateBusiness() {
  ...
  const checkAuthAndLoadData = async () => {
    try {
      ...
      if (!isAuthenticated || !userData) {
        router.push('/auth/login?redirect=/business/create')
        return
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setErrors({ general: response.message || 'Failed to create business' })
      }
    } catch (error) {
  ...
  if (success) {
    return (
      <Layout title="Business Created - ServiceRW">
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            <CheckCircleIcon className="h-16 w-16 text-green-500 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Business Created Successfully!</h2>
            <p className="text-gray-600 mb-4">Your business has been submitted for review.</p>
  ...
  return (
    <Layout
      title="Create Business - ServiceRW"
      description="Create a new business listing on ServiceRW"
      keywords="create business, ServiceRW"
    >
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Add your business to ServiceRW</p>
              </div>
            </div>
          </div>
        </div>
